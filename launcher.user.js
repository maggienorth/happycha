    ...
    window.jQuery.ajax({
        ...
        window.jQuery.get('https://raw.githubusercontent.com/maggienorth/happycha/master/launcher.user.js?' + Math.floor((Math.random() * 1000000) + 1), function(data) {
            ...
            if (latestVersion > myVersion) {
                update("rednelssLauncher", "launcher.user.js", "https://github.com/maggienorth/happycha/blob/" + sha + "/launcher.user.js/");
            }
                ...
                da.prototype = {
                    ...
                    w: function(a) {
                        if (this.N()) {
                            ...
                            !this.n && kb && ":teams" != P ? -1 != ob.indexOf(d) ? (U.hasOwnProperty(d) || (U[d] = new Image, (d == "maggienorth" ? U[d].src = "http://i.imgur.com/Gituy2K.png" : U[d].src = "skins/" +
